...
def transfer(activation):
    #return np.maximum(0.0,activation)       #relu
...
train_network(network, dataset, 0.9, 3000, 1)
for layer in network:
	print(layer)
...
test_dataset=[[None]*3 for i in range(2000)]
for i in range(len(test_dataset)):
    test_dataset[i][0]=random.uniform(-5,15)
    test_dataset[i][1]=random.uniform(-5,15)
    test_dataset[i][2]=None
...
fig = plt.figure()
ax = Axes3D(fig)
ax.scatter(dataset[0][0], dataset[0][1], dataset[0][2], c='k', marker='^')
ax.scatter(dataset[1][0], dataset[1][1], dataset[1][2], c='k', marker='^')
ax.scatter(dataset[2][0], dataset[2][1], dataset[2][2], c='k', marker='^')
ax.scatter(dataset[3][0], dataset[3][1], dataset[3][2], c='k', marker='^')
